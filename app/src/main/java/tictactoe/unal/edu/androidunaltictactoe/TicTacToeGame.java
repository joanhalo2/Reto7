...
public class TicTacToeGame {
    ...
    public int getRandomMove(){
        ...
        do
        {
            i = mRand.nextInt(BOARD_SIZE);
        } while (mBoard[i] == HUMAN_PLAYER || mBoard[i] == COMPUTER_PLAYER);
    ...
    */
    ...
    public void setBoardState(char[] inBoard){
        this.mBoard = inBoard;
    }
}
